    ...
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <img
            alt="Cloudhesive"
            src="https://www.cloudhesive.com/wp-content/uploads/2023/12/Brand-Guidelines_CH-Mono-Horizontal-1-1-e1731005662347.png"
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {(error.username || error.password) && <span className="text-red-500">Username or Password is incorrect</span>}
            </div>
          </form>
        </div>
      </div>
